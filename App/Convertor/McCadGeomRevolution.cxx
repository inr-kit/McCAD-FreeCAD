...
* @author  Lei Lu
************************************************************************/
Standard_Boolean McCadGeomRevolution::Compare(const IGeomFace *& theGeoFace) const
{
                                   ...
                                   Handle_Geom_SurfaceOfRevolution rev)
{
    ...
    if (Abs(p1.X()-p2.X()) <= 1.e-10
            && Abs(p2.X()-p3.X())<=1.e-10)
    {
        pA1 = p1.Y();
        pB1 = p1.Z();
        pA2 = p2.Y();
    ...
    else if (Abs(p1.Y()-p2.Y())<=1.e-10
             && Abs(p2.Y()-p3.Y())<=1.e-10)
    {
        pA1 = p1.X();
        pB1 = p1.Z();
        pA2 = p2.X();
    ...
    else if (Abs(p1.Z()-p2.Z())<=1.0e-10
             && Abs(p2.Z()-p3.Z())<=1.0e-10)
    {
        pA1 = p1.X();
        pB1 = p1.Y();
        pA2 = p2.X();
    ...
    cout<<"center_x   "<<m_Center.X()<<endl;
    cout<<"center_y   "<<m_Center.Y()<<endl;
    cout<<"center_z   "<<m_Center.Z()<<endl;
