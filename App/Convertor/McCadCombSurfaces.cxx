...
McCadSewSurfaces::McCadSewSurfaces()
{
}
...
* @author  Lei Lu
***********************************************************************/
Standard_Boolean McCadSewSurfaces::CanbeMerged(McCadExtFace *& pFaceA, McCadExtFace *& pFaceB)
{
...
* @author Lei Lu
******************************************************************************/
Standard_Boolean McCadSewSurfaces::IsSameSurface(TopoDS_Face &faceA, TopoDS_Face &faceB) const
{
...
* @author Lei Lu
******************************************************************************/
Standard_Boolean McCadSewSurfaces::HasCommonEdge(TopoDS_Face &faceA, TopoDS_Face &faceB) const
{
...
* @author Lei Lu
******************************************************************************/
TopoDS_Face McCadSewSurfaces::Sew(McCadExtFace *& pFaceA, McCadExtFace *& pFaceB )
{
    TopoDS_Face newFace;cout<<"Test3"<<pFaceA->GetFaceType()<<endl;
    if(pFaceA->GetFaceType() == GeomAbs_Cylinder || pFaceA->GetFaceType() == GeomAbs_Cone)
    {
